...
/**
 * Use a TDB persistence model and add FOAF profile to it
 *
 * @author Ekal.Golas
 */
public class lab1_4d {
	...
	public static void main(final String[] args) {
		...
		try {
			...
			FileManager.get()
				.readModel(model, "Ekal_FOAFFriends.rdf");

			dataset.commit();

			// Write model to different formats
			final FileWriter xmlWriter = new FileWriter("Lab1_4_EkalGolas.xml");
			final FileWriter ntpWriter = new FileWriter("Lab1_4_EkalGolas.ntp");
			final FileWriter n3Writer = new FileWriter("Lab1_4_EkalGolas.n3");
